                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                ...
                                <p class="mb-0">Entrez votre adresse mail et votre mot de passe pour vous connecter</p>
                            </div>
                            <div class="card-body">
                                <form role="form" action="{{route('admin.login')}}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <input type="email" class="form-control" name="email" placeholder="Votre Email" aria-label="Email">
                                    </div>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    ...
                                    <a href="{{route('register')}}" class="text-info text-gradient font-weight-bold">Inscription</a>
                                </p>
                            </div>
                        </div>
                    </div>
